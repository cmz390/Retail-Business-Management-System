...
class SQLPL{
  ...
  public void show(int index) throws SQLException
  {
    try
    {
        ...
        Connection conn = ds.getConnection("mchen135", "MFYsyc175986");
    ...
    try
    {
        ...
        while (rs.next()) {
            System.out.println(
                ...
                String.format("%-12s", rs.getString(1)) +
                String.format("%-12s", rs.getString(2)) + 
                String.format("%-12s", rs.getString(3)) +
               String.format("%-12s", rs.getString(4)) + 
               String.format("%-12s", rs.getString(5))  +
               String.format("%-12s", rs.getString(6)) +
                rs.getString(7)
